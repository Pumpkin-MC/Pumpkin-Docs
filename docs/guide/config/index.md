...
Pumpkin aims to support the latest Minecraft Version. If you want to host a Pumpkin server in any other version, use a project called [ViaProxy](https://github.com/ViaVersion/ViaProxy).
