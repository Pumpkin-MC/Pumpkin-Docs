...
Pumpkin cung cấp một hệ thống cấu hình mạnh mẽ cho phép người dùng tùy chỉnh các khía cạnh khác nhau của server mà không cần dựa vào plugin bên ngoài. Điều này mang lại sự linh hoạt và kiểm soát đối với hoạt động của server.
...
Pumpkin nhắm đến việc hỗ trợ phiên bản Minecraft mới nhất. Nếu bạn muốn thiết lập server Pumpkin cho bất kỳ phiên bản nào khác, có một dự án khác gọi là [ViaProxy](https://github.com/ViaVersion/ViaProxy).
...
- Tùy chỉnh mạnh mẽ: Cấu hình cài đặt server, hành vi người chơi, tạo thế giới và nhiều hơn nữa.
